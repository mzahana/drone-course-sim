#!/usr/bin/env python3
"""Lab 5 skeleton, part 2 -- the standoff law, with the clamps.
...
class FollowGuidance(Node):
    ...
    def _tick(self):
        ...
        # --- the reference ------------------------------------------------
        # TODO(student): the standoff reference: p_des = p_T - d * v_hat_T + h * z_hat.
        # self.d, self.h; the target is at (tx, ty) moving at
        ...
        # TODO(student): the clamps, applied AFTER the law and allowed to overrule it.
        #   * horizontal speed <= self.vmax (scale vx, vy together,
